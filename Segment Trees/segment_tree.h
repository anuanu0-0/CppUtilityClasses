/* 
    How to use the header : 
        1) Include the header name in the desired file.
        2) Important Paramenters / Specifications to construct a segment tree : 
                -> Datatype of the array for which tree is to be constructed
                -> Array / vector from which tree is to be constructed
                -> Default Value for filling the extra nodes of the tree.
                -> Function to determine value of current node based on its left and right child 
